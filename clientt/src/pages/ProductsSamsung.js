...
// Ripërdor stilet premium (product-card, products-grid, filters-bar, btn-accent, iphone-page)
  ...
  return (
    <div className="modern-product-card">
      ...
      <div className="modern-product-info">
        <div className="product-category-label">SAMSUNG</div>
...
const ProductsSamsung = () => {
  ...
  // JSON-LD: Breadcrumbs (Home > Produktet > Samsung)
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Samsung", item: "https://topmobile.store/products/samsung" },
    ],
  };
  ...
  return (
    <Box className="iphone-page" sx={{ maxWidth: 1300, mx: "auto", py: 5, px: { xs: 1, md: 4 } }}>
      <SEO
        title="Samsung – Modelet më të kërkuara"
        description="Shfleto modelet Samsung në Top Mobile – gjendje e shkëlqyer, çmime të mira dhe garanci. Dërgesa e shpejtë në gjithë Kosovën."
        url="https://topmobile.store/products/samsung"
